    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["common_name"], name="mammals_mam_common__006db6_idx"
                    ),
                    models.Index(
                        fields=["continent"], name="mammals_mam_contine_7cb82a_idx"
                    ),
                    models.Index(
                        fields=["taxonomy_order"], name="mammals_mam_taxonom_1616a3_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user"], name="mammals_fav_user_id_c4967d_idx"
                    ),
                    models.Index(
                        fields=["mammal"], name="mammals_fav_mammal__a4d5ba_idx"
                    ),
                ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content",
                    models.TextField(
                        help_text="Conteúdo do comentário", verbose_name="Conteúdo"
                    ),
                ),
                (
                    "created_at",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["mammal", "-created_at"],
                        name="mammals_com_mammal__00650b_idx",
                    ),
                    models.Index(
                        fields=["user"], name="mammals_com_user_id_f28a89_idx"
                    ),
                ],
            },
        ),
