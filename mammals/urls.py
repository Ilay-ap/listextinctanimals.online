...
urlpatterns = [
    path("log-error/", views.log_js_error, name="log_error"),
    # Páginas públicas
    ...
    path('admin_panel/<int:pk>/edit/', views.admin_edit_mammal, name='admin_edit_mammal'),
    path('admin_panel/<int:pk>/delete/', views.admin_delete_mammal, name='admin_delete_mammal'),
    
    # Admin - Usuários
    path('admin_panel/users/', views.admin_users, name='admin_users'),
    path('admin_panel/users/<int:user_id>/toggle_admin/', views.admin_toggle_admin, name='admin_toggle_admin'),
    path('admin_panel/users/<int:user_id>/delete/', views.admin_delete_user, name='admin_delete_user'),
]
