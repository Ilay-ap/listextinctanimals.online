...
class TestRoutes:
    ...
    def test_search_returns_valid_json(self):
        ...
        """
        response = self.client.get(reverse("mammals:search"), {"q": "Tigre"})
...
class TestSearchFilters:
    ...
    def test_search_by_continent(self):
        ...
        response = self.client.get(reverse("mammals:search"), {"region": "Africa"})
    ...
    def test_search_by_taxonomy(self):
        ...
        response = self.client.get(reverse("mammals:search"), {"taxonomy": "CARNIVORA"})
    ...
    def test_search_combined_filters(self):
        ...
        response = self.client.get(
            reverse("mammals:search"), {"q": "leão", "continent": "Africa"}
        )
