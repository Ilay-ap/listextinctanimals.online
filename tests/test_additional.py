...
class TestFavoritesView:
    ...
    def setup(self):
        ...
        self.mammal1 = Mammal.objects.create(
            common_name="Mamífero 1", binomial_name="Species one"
        )

        self.mammal2 = Mammal.objects.create(
            common_name="Mamífero 2", binomial_name="Species two"
        )
...
class TestMammalDetailView:
    ...
    def test_detail_page_shows_comments(self):
        ...
        Comment.objects.create(
            mammal=self.mammal, user=self.user, content="Comentário 1"
        )
        Comment.objects.create(
            mammal=self.mammal, user=self.user, content="Comentário 2"
        )
    ...
    def setup(self):
        ...
        for i in range(5):
            Mammal.objects.create(
                common_name=f"Mamífero {i}", binomial_name=f"Species {i}"
            )
...
class TestModelMethods:
    ...
    def test_mammal_get_absolute_url(self):
        ...
        mammal = Mammal.objects.create(common_name="Teste", binomial_name="Test test")
    ...
    def test_comment_str_representation(self):
        ...
        comment = Comment.objects.create(
            mammal=mammal, user=user, content="Comentário teste"
        )
    ...
    def test_favorite_str_representation(self):
        ...
        favorite = Favorite.objects.create(user=user, mammal=mammal)
...
class TestSearchEndpoint:
    ...
    def test_search_by_description(self):
        ...
        response = self.client.get(reverse("mammals:search"), {"q": "marsupial"})
