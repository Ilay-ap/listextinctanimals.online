...
class TestDatabaseQueries:
    ...
    def test_mammal_with_comments_count(self):
        ...
        Comment.objects.create(
            mammal=self.mammal1, user=self.user1, content="Comentário 1"
        )
        Comment.objects.create(
            mammal=self.mammal1, user=self.user2, content="Comentário 2"
        )

        # Buscar mamífero com contagem de comentários
        mammal = Mammal.objects.annotate(comment_count=Count("comments")).get(
            pk=self.mammal1.pk
        )
    ...
    def test_mammal_with_favorites_count(self):
        ...
        mammal = Mammal.objects.annotate(favorite_count=Count("favorited_by")).get(
            pk=self.mammal1.pk
        )
    ...
    def test_short_description_property(self):
        ...
        mammal = Mammal.objects.create(
            common_name="Teste", binomial_name="Test test", description=long_desc
        )
    ...
    def test_comment_ordering(self):
        ...
        comment1 = Comment.objects.create(
            mammal=self.mammal1, user=self.user1, content="Primeiro"
        )

        comment2 = Comment.objects.create(
            mammal=self.mammal1, user=self.user2, content="Segundo"
        )
    ...
    def test_cascade_delete_mammal(self):
        ...
        Comment.objects.create(
            mammal=self.mammal1, user=self.user1, content="Comentário"
        )
        Favorite.objects.create(user=self.user1, mammal=self.mammal1)
