...
class TestCRUDOperations:
    ...
    def test_add_comment_success(self):
        ...
        """
        # Dados do comentário
        comment_data = {"content": "Este é um comentário de teste sobre o Dodo."}
        ...
        assert Comment.objects.filter(mammal=self.mammal, user=self.user).exists()
...
class TestCRUDEdgeCases:
    ...
    def test_add_empty_comment_fails(self):
        ...
        assert any(
            "empty" in str(m).lower() or "vazio" in str(m).lower() for m in messages
        )
    ...
    def test_unauthenticated_user_cannot_add_comment(self):
        ...
        comment_data = {"content": "Tentando comentar sem estar logado"}
    ...
    def test_multiple_users_can_favorite_same_mammal(self):
        ...
        user2 = User.objects.create_user(username="user2", password="senha123")
